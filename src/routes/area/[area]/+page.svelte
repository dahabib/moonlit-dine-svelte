<script>
    ...
    const area = $page.url.pathname.split("/",3)[2];
...
<section class="fluid bg-orange-200">
    <div class="container mx-auto mt-16">  
        <div class="my-4 py-4 text-center sm:text-4xl text-5xl text-lime-700">{meals.length} <span class="text-bold text-pink-600 underline">{area}</span> meals.</div>
